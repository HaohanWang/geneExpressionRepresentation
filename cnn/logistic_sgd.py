...
def load_data(cv=1):
    ...
    train_set_x1, train_set_y = shared_dataset(trda, trl)
    train_set_x2, train_set_y = shared_dataset(trdb, trl)
    valid_set_x1, valid_set_y = shared_dataset(teda,tel)
    valid_set_x2, valid_set_y = shared_dataset(tedb,tel)
